...
- **React Native** `0.81.5` — Framework para desenvolvimento de aplicações mobile nativas
...
├── assets/                          # Recursos visuais (ícones, splash screen)
│   ├── adaptive-icon.png
│   ├── favicon.png
│   ├── icon.png
│   └── splash-icon.png
...
|-----------------|------------|---------------------------------------------------------|
| `Especialidade` | `type`     | `id`, `nome`, `descricao?`                              |
| `Paciente`      | `type`     | `id`, `nome`, `cpf`, `email`, `telefone?`               |
| `Medico`        | `interface`| `id`, `nome`, `crm`, `especialidade`, `ativo`           |
